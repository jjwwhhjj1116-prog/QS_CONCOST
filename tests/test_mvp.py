...
class MVPTests(unittest.TestCase):
    ...
    def test_manual_collection_prioritizes_opportunities_over_heavy_analysis(self):
        ...
        self.assertTrue(is_manual_safe_collection(scopes))
        self.assertFalse(is_manual_safe_collection({"g2b"}))
    ...
    def test_weekday_automation_windows(self):
        ...
        friday_evening = datetime(2026, 7, 10, 17, 30)
        ...
        self.assertTrue(in_collect_window(friday_evening))
        self.assertTrue(in_collect_window(friday_digest))
