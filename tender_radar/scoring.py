...
SCORING_VERSION = "concost-consulting-v3"
...
SERVICE_GROUPS = {
    ...
    "평가·심의위원": {
        "공법선정위원회": 58, "공법선정": 52, "건설기술심의": 56,
        "건축위원회": 50, "정비사업 심의": 50, "산업단지계획 심의": 42,
        "설계공모 심사": 48, "기술입찰": 44, "제안서 평가위원": 36,
        "평가위원 후보자": 34, "평가위원": 30, "심사위원": 28,
        "위원 공개모집": 24, "선정심의위원회": 24,
    },
}
